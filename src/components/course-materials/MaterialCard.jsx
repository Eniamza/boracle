            ...
            <Card className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                <div className="flex">
                    ...
                    <div className="flex-1 p-3 sm:p-4 min-w-0">
                        ...
                        {/* Description */}
                        <div className="mb-3">
                            <p className={`text-sm text-gray-700 dark:text-gray-300 leading-relaxed ${!expanded ? 'line-clamp-1' : ''}`}>
                                {material.postDescription}
                            </p>
                            {material.postDescription?.length > 80 && (
                                <button
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-blue-500 hover:bg-blue-600 text-white transition-colors shadow-sm"
                            >
                            ...
                            <Button
                                size="sm"
                                variant="outline"
                                className="h-7 px-3 text-xs gap-1.5 bg-green-500 hover:bg-green-600 dark:bg-green-500 dark:hover:bg-green-600 border-green-500 dark:border-green-500 text-white dark:text-white shadow-sm"
                            ...
                            <Button
                                size="sm"
                                variant="ghost"
                                className="h-7 px-2 text-xs gap-1 text-gray-500 hover:text-blue-500"
                                onClick={handleShare}
                            >
